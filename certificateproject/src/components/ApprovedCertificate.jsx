...
//   <div className="relative w-full max-w-4xl" ref={certRef}>
//     {/* Outer Border */}
...
//      <div className="inline-block bg-gradient-to-br from-emerald-700 to-emerald-600 rounded-full p-1 mb-4">
//       <div className="bg-white rounded-full w-24 h-24 flex items-center justify-center border-4 border-emerald-600">
//         <img src={StateLogo} alt="State Logo" className="w-20 h-20 object-contain" />
//       </div>
//     </div>
...
//   {/* Passport */}
//   <div className="ml-4 border-4 border-gray-300 bg-white p-1 w-32 h-32 shrink-0">
//     {image ? (
//       <img
...
//           {/* Title */}
//           <h3
//             className="text-5xl font-serif text-center mb-8 text-amber-700"
...
//             <p className="font-medium" >
//               of
//               <span className="font-bold border-b-2 border-gray-400 inline-block min-w-[300px] ml-2">
//                 {address}
//               </span>
//             </p>
...
//             <p className="font-medium">
//               is a native of
//               <span className="font-bold border-b-2 border-gray-400 inline-block min-w-[150px] mx-1">
//                 {lga}
//               </span>
//               of
//               <span className="font-bold border-b-2 border-gray-400 inline-block min-w-[150px] mx-1">
...
//                   className="w-28 h-16 mx-auto mb-2 object-contain"
//                   alt="Secretary Signature"
//                 />
//               )}

//               <div className="border-t-2 border-gray-400 pt-2">
//                 <div className="font-bold text-lg">{signatory?.secretaryName}</div>
//                 <div className="text-gray-600 font-semibold">({effectiveLga})</div>
//               </div>
//             </div>
...
//               <div className="border-t-2 border-gray-400 pt-2">
//                 <div className="font-bold text-lg">{signatory?.chairmanName}</div>
//                 <div className="text-gray-600">({effectiveLga})</div>
//               </div>
//             </div>
//           </div>
